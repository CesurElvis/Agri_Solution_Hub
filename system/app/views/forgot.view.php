    ...
    <div class="container">
        <div class="row">
            <div class="col-md-7 text-center py-md-5 py-4 h1">
                <span class="text-secondary"> <strong>Welcome to</strong></span>
                <div style="font-family:cursive;">
                    <span class="text-primary">Agri_Solu</span>
                    <span style="color:#6610f2; ">tion_Hub</span>
                </div>
                <div class="visible-logo">
                    <img src="<?php echo ROOT ?>/assets/img/fruitnull.png" class="img-fluid" alt="">
                </div>
            </div>
            <div class="col-md-5">
                ...
                <div class="card containerDiv " lstyle="
                    ...
                    <form class="card-body  email">
                        ...
                        <div class="form-outline mt-2 ">
                            <div class="mb-4 text-center">
                                <a class="btn btn text-dark" href="<?php echo ROOT ?>/login" style="background-color:lightgreen !important;">back</a>
                                <div onclick="send1_data()" class="btn w-50 btn btn-block " style="background-color:green !important;"> continue</div>
                    ...
                    <form  class="card-body code cs-code ">
                        ...
                        <div class="form-outline mt-2 ">
                            <div class="mb-4 text-center">
                                <a class="btn btn text-dark" style="background-color:lightgreen !important;" href="<?php echo ROOT ?>/login">back</a>
                                <div style="background-color:green !important;"  onclick="send2_data()" class="btn w-50 btn-primary btn-block ">continue</div>
                    ...
                    <form class="card-body pass ">
                        ...
                        <div class="form-outline mt-2 ">
                            ...
                            <div class="mb-4 text-center">
                                <a style="background-color:lightgreen !important;" class="btn btn-dark text-light" href="<?php echo ROOT ?>/login">back</a>
                                <div style="background-color:green !important;" onclick="send3_data()" class="btn w-50 btn-primary btn-block ">
                                    continue
                                </div>
                            </div>
                            <div class="text-center">
