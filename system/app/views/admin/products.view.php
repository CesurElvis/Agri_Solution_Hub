    ...
    <div class="row">
      ...
      <div class="col-md-6">
        ...
        <div class="card-body mt-3">
          ...
          <div class="mb-3">
            <input type="text" value="<?php echo esc(check('price')) ?? '' ?>" name="price" class="form-control js-on"
              oninput="save_changes()" placeholder="Product price">
          </div>
          <div class="mb-3">
            <input type="text" name="quality" class="form-control " oninput="save_changes()"
    ...
    <div class="row">
      ...
      <div class="col-md-6">
        <div class="card-body mt-3">
          ...
          <div class="mb-3">
            <input type="text" value="<?php echo esc(check('price',esc($product->price))) ?? '' ?>" name="price" class="form-control js-on"
              oninput="save_changes()" placeholder="Product price">
          </div>
          <?php if(!empty($errors['price'])): ?>
            <div class="text-danger"><?php echo esc($errors['price'])?></div>
            <?php endif;?>
            <div class="js-price text-danger"></div>
          <div class="mb-3">
            <input type="text" name="quality" value="<?php echo esc(check('quality',$product->quality)) ?? ""?>" class="form-control js-on " oninput="save_changes()"
              placeholder="Product quality">
          </div>
          <?php if(!empty($errors['quality'])): ?>
            <div class="text-danger"><?php echo esc($errors['quality'])?></div>
            <?php endif;?>
            <div class="js-quality text-danger"></div>
        </div>
          ...
          <div class="card-body mt-3">
            ...
            <div class="form-floating">
              <textarea value=" " oninput="save_changes()" name="features" class="form-control"
                placeholder="Address" id="floatingTextarea" style="height: 100px;">
            <?php echo esc(check('features',esc($product->features))) ?? '' ?>
                    </textarea>
              <label for="floatingTextarea">product features</label>
            </div>
            <?php if(!empty($errors['features'])): ?>
            <div class="text-danger mb-1"><?php echo esc($errors['features'])?></div>
            <?php endif;?>
            <div class="js-features text-danger"></div>
  ...
  <?php endif?>
    ...
    <script>
      ...
      function display(file) {
        ...
        var allowedext = ['img', 'png', 'jpg', 'webp', 'jpeg', 'avif'];
            ...
            if(result.includes("product_name"))
             ...
             if(result.includes("price"))
              ...
              if(result.includes("quality"))
              {
                ...
                var quality = document.querySelector(".js-quality");
                quality.innerHTML = obj.quality;
